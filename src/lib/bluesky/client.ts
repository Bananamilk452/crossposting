...
const blueskyClient = new NodeOAuthClient({
  clientMetadata: {
    client_id: `${process.env.PUBLIC_URL}/auth/client-metadata`,
    client_name: "crossposting.junsu.io",
    ...
    redirect_uris: [`${process.env.PUBLIC_URL}/callback/bluesky`],
    ...
    jwks_uri: `${process.env.PUBLIC_URL}/auth/jwks`,
  },
